...
AM.queueDownload("./img/kennyMap-export.png");
...
AM.queueDownload("./img/wallAnimation.png");
AM.queueDownload("./img/shadow.png");
AM.queueDownload("./img/movement.png");
AM.queueDownload("./img/randomLocation.png");
AM.downloadAll(function () {
    ...
    var camera = new Camera(gameEngine, player, AM.getAsset("./img/kennyMap-export.png"), 2688, 1392);
    gameEngine.start(player, camera);
    gameEngine.addEntity(new Background(gameEngine, AM.getAsset("./img/kennyMap-export.png")));
    gameEngine.addEntity(new Background(gameEngine, AM.getAsset("./img/kennyMap-export.png")));
   ...
   // gameEngine.addEntity(new wall(gameEngine, AM.getAsset("./img/wallAnimation.png")));
    gameEngine.addEntity(new shadowBoss(gameEngine,AM.getAsset("./img/randomLocation.png"),AM.getAsset("./img/movement.png"),AM.getAsset("./img/shadow.png")));
